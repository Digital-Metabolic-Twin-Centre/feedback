...
The migration command runs tracked SQLite migrations and records them in `schema_migrations`. Existing databases are adopted into the baseline migration automatically the first time they run the new migrator.
